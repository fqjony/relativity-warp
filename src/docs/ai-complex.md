...
description: AI and complex problems: what breaks, why, and how to build a reliable workflow.
---
...
![Prompt overload versus prompt as workflow](/assets/ai-complex/prompt-overload-vs-workflow.svg)
...
![Workflow step structure with inputs, actions, outputs, and verification](/assets/ai-complex/workflow-step-structure.svg)
...
![Dynamic knowledgebase loop for prompt-as-workflow](/assets/ai-complex/dynamic-knowledge-loop.svg)
...
Diagram sources live in `src/docs/ai-complex.md` and are exported to `src/assets/ai-complex/`.
